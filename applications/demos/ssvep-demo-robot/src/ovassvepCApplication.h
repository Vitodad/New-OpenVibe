...
namespace OpenViBESSVEP
{
	class CApplication : public Ogre::FrameListener, public Ogre::WindowEventListener
	{
		public:
			...
			std::string getStaubliRobot_Host(){
				return m_StaubliHost;
			}

			int getStaubliRobot_Port(){
				return m_StaubliPort;
			}
		...
		protected:
			...
			int m_StaubliPort;
			std::string m_StaubliHost;


		private:
			void initCEGUI(const char *logFileName);
			
			Ogre::uint32 m_ui32WindowWidth, m_ui32WindowWidth2;
			Ogre::uint32 m_ui32WindowHeight, m_ui32WindowHeight2;
