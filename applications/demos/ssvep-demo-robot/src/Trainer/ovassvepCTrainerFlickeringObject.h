...
namespace OpenViBESSVEP
{
	...
	class CTrainerFlickeringObject : public CSSVEPFlickeringObject
	{
		...
		private:
			...
			static CTrainerApplication* m_poApplication2;
			static Ogre::SceneNode* m_poParentNode2;
			static CBasicPainter* m_poPainter2;
			static OpenViBE::float32 m_f32TargetWidth2;
			static OpenViBE::float32 m_f32TargetHeight2;
			static Ogre::ColourValue m_oLightColour2;
			static Ogre::ColourValue m_oDarkColour2;
